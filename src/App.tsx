...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
        ...
        <div className="max-w-5xl mx-auto md:px-6 px-4 py-4 gap-2 flex justify-between items-center">
          <div className="flex flex-row gap-4 items-center justify-center">
            ...
            <motion.a 
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#126ab5" className="bi bi-whatsapp" viewBox="0 0 16 16">
            ...
            <motion.a 
              ...
              className="cursor-pointer rounded-full p-2 border-2 border-secondary hidden md:flex">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#126ab5" className="bi bi-instagram" viewBox="0 0 16 16">
      ...
      {/* Services Grid */}
      <section id="servicios" className="border-y-2  border-secondary px-6 bg-slate-200">
        <div className="py-8 max-w-5xl mx-auto">
          <h3 className="text-3xl w-fit mx-auto px-10 font-bold text-primary mb-10 text-center">
            Nuestros Servicios
          </h3>
          <div className="grid md:grid-cols-2 gap-10 max-w-3xl mx-auto">
            <div className="w-full flex flex-col shadow-md bg-white rounded-lg border-2 border-secondary overflow-hidden">
              ...
              <div className="p-8 relative">
                <div className="flex items-center justify-center h-24 p-4 aspect-square bg-light border-2 border-secondary shadow-lg rounded-full absolute top-0 -translate-y-1/2">
                  <ChartNoAxesCombined className="w-full h-full text-primary"/>
                </div>
                <p className="text-lg font-bold mb-2 mt-8 text-primary">Puesto de Bolsa Agropecuaria</p>
                <div>
                {
                  [
            ...
            <div className="w-full flex flex-col shadow-md bg-white rounded-lg border-2 border-secondary overflow-hidden">
              ...
              <div className="p-8 relative">
                ...
                <p className="text-lg font-bold mb-2 mt-8 text-primary">Servicios Profesionales de Contabilidad</p>
                <div>
                {
                  [
      ...
      <section id="questions" className="md:py-20 py-6 px-6">
        <div className="mx-auto max-w-5xl flex flex-col md:grid md:grid-rows-2 gap-16">
          <div className="md:grid md:grid-cols-3 w-full">
            <div className="py-8 md:border-r-2 border-secondary md: md:h-full mx-auto">
              <img
          ...
          <div className="md:grid md:grid-cols-3 w-full">
            ...
            <div className="py-8 md:border-l-2 border-secondary md: md:h-full mx-auto">
              <img
