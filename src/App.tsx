...
function MapEmbed() {
  ...
  return (
    <iframe
      title="Ubicación de BUCONIC, SA en Chinandega, Nicaragua"
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      {/* Navigation */}
      <nav className="bg-white border-b-2 border-secondary shadow-xl fixed w-full top-0 z-50" role="navigation" aria-label="Navegación principal">
        <div className="max-w-5xl mx-auto md:px-6 px-4 py-4 gap-2 flex justify-between items-center">
          <div className="flex flex-row gap-4 items-center justify-center">
            <img src="/buconicsa.jpg" alt="Logo de BUCONIC SA - Bursátiles y Contabilidad de Nicaragua" className="h-12" />
            <h1 className="font-bold md:text-2xl text-lg text-primary">BUCONIC, SA</h1>
            <motion.a 
              href="https://wa.me/50588123313"
              title="Contactar por WhatsApp a BUCONIC SA"
              ...
              className="cursor-pointer rounded-full p-2 border-2 border-secondary hidden md:flex">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#126ab5" className="bi bi-whatsapp" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <motion.a 
              ...
              title="Seguir a BUCONIC SA en Instagram"
              ...
              className="cursor-pointer rounded-full p-2 border-2 border-secondary hidden md:flex">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#126ab5" className="bi bi-instagram" viewBox="0 0 16 16" aria-hidden="true">
      ...
      <aside className="fixed bottom-6 right-6 flex flex-col gap-3 z-50 md:hidden" aria-label="Redes sociales">
        <motion.a 
          href="https://wa.me/50588123313"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#126ab5" className="bi bi-whatsapp" viewBox="0 0 16 16" aria-hidden="true">
            <path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/>
          </svg>
        </motion.a>
        <motion.a 
          ...
          className="cursor-pointer rounded-full p-3 border-2 border-secondary">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#126ab5" className="bi bi-instagram" viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.9 3.9 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599s.453.546.598.92c.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92s.546-.453.92-.598c.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92m-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217m0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334"/>
          </svg>
        </motion.a>
      </aside>
      ...
      {/* Hero Section */}
      <section className="mt-36 mb-20 lg:border-l-2 border-secondary max-w-5xl mx-auto md:py-8 px-8 lg:px-0" aria-labelledby="hero-heading">
        <div className="lg:grid lg:grid-cols-2">
          <div className="md:pl-6 mx-auto h-max">
            <div className="max-w-3xl">
              <h2 id="hero-heading" className="md:text-5xl text-3xl font-bold text-primary mb-6">
          ...
          <div className="relative h-full lg:block hidden">
              <img 
                ...
                src="/main.jpg"
                alt="Equipo profesional de BUCONIC SA trabajando en servicios contables y bursátiles"
              />
          </div>
        </div>
        <article className="text-slate-700 w-full mt-16 text-justify bg-white p-6 border-2 border-secondary lg:border-l-0 rounded-md lg:rounded-l-none shadow-md flex flex-col gap-4">
          <p>
            Somos un equipo de profesionales que aporta valor a su organización mediante asesorías personalizadas que fortalecen sus procesos contables, técnicas de control interno y optimización de obligaciones tributarias.
          </p>
          <p>
      ...
      {/* Services Grid */}
      <section id="servicios" className="border-y-2 border-secondary px-6 bg-slate-200" aria-labelledby="services-heading">
        <div className="py-8 max-w-5xl mx-auto">
          <h3 id="services-heading" className="text-3xl w-fit mx-auto px-10 font-bold text-primary mb-10 text-center">
            Nuestros Servicios
          </h3>
          <div className="grid md:grid-cols-2 gap-10 max-w-3xl mx-auto">
            <article className="w-full flex flex-col shadow-md bg-white rounded-lg border-2 border-secondary overflow-hidden">
              <div className="h-48 bg-slate-400 overflow-hidden border-b-2 border-secondary">
                <img 
                  ...
                  alt="Productos agropecuarios - Servicio de Bolsa Agropecuaria en Nicaragua"
                  className="object-cover -translate-y-0"
                />
              </div>
              <div className="p-8 relative">
                <div className="flex items-center justify-center h-24 p-4 aspect-square bg-light border-2 border-secondary shadow-lg rounded-full absolute top-0 -translate-y-1/2" aria-hidden="true">
                  <ChartNoAxesCombined className="w-full h-full text-primary"/>
                </div>
                <h4 className="text-lg font-bold mb-2 mt-8 text-primary">Puesto de Bolsa Agropecuaria</h4>
                <ul>
                {
                  [
            ...
            <article className="w-full flex flex-col shadow-md bg-white rounded-lg border-2 border-secondary overflow-hidden">
              <div className="h-48 bg-slate-400 overflow-hidden border-b-2 border-secondary">
                <img 
                  ...
                  alt="Servicios profesionales de contabilidad y auditoría en Nicaragua"
                  className="object-cover -translate-y-0"
                />
              </div>
              <div className="p-8 relative">
                ...
                <h4 className="text-lg font-bold mb-2 mt-8 text-primary">Servicios Profesionales de Contabilidad</h4>
                <ul>
                {
                  [
      ...
      {/* Questions Section */}
      <section id="questions" className="md:py-20 py-6 px-6" aria-labelledby="faq-heading">
        <h2 id="faq-heading" className="sr-only">Preguntas frecuentes sobre BUCONIC SA</h2>
        <div className="mx-auto max-w-5xl flex flex-col md:grid md:grid-rows-2 gap-16">
          <article className="md:grid md:grid-cols-3 w-full">
            <div className="py-8 md:border-r-2 border-secondary md:h-full mx-auto">
              <img
                ...
                alt="Equipo profesional de asesoría bursátil y contable en Nicaragua"
                className="md:rounded-l-md md:rounded-r-none rounded-md shadow-md border-2 border-secondary md:border-r-0 overflow-hidden h-full object-cover md:w-auto w-full"
              />
            </div>
          ...
          <article className="md:grid md:grid-cols-3 w-full">
            ...
            <div className="py-8 md:border-l-2 border-secondary md:h-full mx-auto">
              <img
                ...
                alt="Beneficios fiscales de la Bolsa Agropecuaria de Nicaragua"
                className="md:rounded-r-md md:rounded-l-none rounded-md shadow-md border-2 border-secondary md:border-l-0 h-full overflow-hidden object-cover md:w-auto w-full"
              />
            </div>
          </article>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-4xl mb-16 text-left mx-auto grid md:grid-cols-2">
            ...
            <address className="md:pl-3 md:border-l-1 flex gap-4 flex-col justify-center not-italic">
              <div className="flex gap-2 font-bold flex-row items-center">
                <Phone className="w-8 aspect-square flex-shrink-0" aria-hidden="true" />
                <a
                  href="tel:+50588123313"
                  className="hover:underline"
                  aria-label="Llamar al +505 8812-3313"
                >
                  +505 8812-3313
                </a>
                <button
              ...
              <div className="flex gap-2 font-bold flex-row items-center">
                <Mail className="w-8 aspect-square flex-shrink-0" aria-hidden="true" />
                <a
                  href="mailto:wmadrigal@buconicsa.com"
                  className="hover:underline"
                  aria-label="Enviar correo a wmadrigal@buconicsa.com"
                >
                ...
                <button
                  ...
                  className="ml-auto p-1 hover:bg-white/20 rounded transition"
                  title="Copiar email"
                  aria-label={copiedField === "email" ? "Email copiado" : "Copiar email"}
                >
                  {copiedField === "email" ? (
                    <Check className="w-5 h-5" aria-hidden="true" />
                  ) : (
              ...
              <div className="flex gap-2 font-bold flex-row items-center">
                <MapPin className="w-8 aspect-square flex-shrink-0" aria-hidden="true" />
                  <span>
                  ...
                  <button
                    ...
                    aria-label={copiedField === "address" ? "Dirección copiada" : "Copiar dirección"}
                  >
                    {copiedField === "address" ? (
                      <Check className="w-5 h-5" aria-hidden="true" />
                    ) : (
          ...
          <div className="mx-auto flex flex-col">
            ...
            <motion.a
              ...
              title="Enviar correo para solicitar consulta"
      ...
      {/* Footer */}
      <footer className="bg-primary text-light py-8 px-6">
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "name": "BUCONIC, S.A.",
          "alternateName": "Bursátiles y Contabilidad de Nicaragua, S.A.",
          "description": "Más de 10 años ayudando a empresas a optimizar ingresos, rentabilidad, productividad de equipos y flujo de efectivo. Servicios de Bolsa Agropecuaria y Contabilidad profesional en Nicaragua.",
          "url": window.location.origin,
          "telephone": "+50588123313",
          "email": "wmadrigal@buconicsa.com",
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "Esquina de los bancos 20 vrs al sur",
          ...
          "priceRange": "$$",
          "sameAs": [
            "https://www.instagram.com/buconic_sa/",
            "https://wa.me/50588123313"
          ],
          "areaServed": {
            "@type": "Country",
            "name": "Nicaragua"
          ...
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Servicios de BUCONIC",
            "itemListElement": [
              {
                "@type": "Offer",
                "itemOffered": {
                  "@type": "Service",
                  "name": "Puesto de Bolsa Agropecuaria",
                  "description": "Elaboración de Contratos de compra/venta en Bolsa Agropecuaria, asesorías fiscales y capacitaciones"
                }
              },
              {
                "@type": "Offer",
                "itemOffered": {
                  ...
                  "description": "Certificación de Estados Financieros, Asesoría de Impuestos, Auditorías financieras y especiales"
                }
              }
            ]
          }
